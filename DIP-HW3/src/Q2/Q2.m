...
center_x = floor(rows_w/2);
center_y = floor(cols_w/2);
patch_size = 128;  
half_patch = floor(patch_size/2);

% Replace lower half frequency components
F_combined = F_woman_shifted;
F_combined(center_x-half_patch:center_x+half_patch, center_y-half_patch:center_y+half_patch) = F_parrot_shifted(center_x-half_patch:center_x+half_patch, center_y-half_patch:center_y+half_patch);
